/* global jQuery */
/* global wp */
function cryptoairdrop_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function cryptoairdrop_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function cryptoairdrop_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + cryptoairdrop_customizer_repeater_uniqid();
    ...
    cryptoairdrop_customizer_repeater_refresh_general_control_values();
}


function cryptoairdrop_customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
			...
			var event_completed = jQuery(this).find('.customizer-repeater-roadmap-control').val();
			var video_url = jQuery(this).find('.customizer-repeater-video-url-control').val();
			var date = jQuery(this).find('.customizer-repeater-date-control').val();
            var id = jQuery(this).find('.social-repeater-box-id').val();
            if (!id) {
                id = 'social-repeater-' + cryptoairdrop_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || designation !== '' || open_new_tab !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || date !== '' || button_text !== '' || slide_format !== '' || event_completed !== '' || video_url !== '') {
                values.push({
                    'icon_value': (choice === 'customizer_repeater_none' ? '' : icon_value),
                    'color': color,
                    'text': cryptoairdrop_escapeHtml(text),
                    'link': link,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
                    'title': cryptoairdrop_escapeHtml(title),
                    'subtitle': cryptoairdrop_escapeHtml(subtitle),
                    'social_repeater': cryptoairdrop_escapeHtml(social_repeater),
                    'id': id,
                    'shortcode': cryptoairdrop_escapeHtml(shortcode),
...
jQuery(document).ready(function () {
    ...
    cryptoairdrop_media_upload('.customizer-repeater-custom-media-button');
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-cryptoairdrop_contact_content')
		{	
			var numItems = jQuery("#customize-control-cryptoairdrop_contact_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 3){
			  jQuery( "#customize-control-cryptoairdrop_contact_upgrade .cryptoairdrop-upgrade-pro-message" ).show();
			  return false;   
			}
		}
		
		if(parentid == 'customize-control-cryptoairdrop_service_content')
		{
			var numItems = jQuery("#customize-control-cryptoairdrop_service_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 3){ 
			  jQuery( "#customize-control-cryptoairdrop_service_upgrade .cryptoairdrop-upgrade-pro-message" ).show();
			  return false;   
			}
		}/*
		if(parentid == 'customize-control-cryptoairdrop_project_content')
		{
			var numItems = jQuery("#customize-control-cryptoairdrop_project_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 4){ 
			  jQuery( "#customize-control-cryptoairdrop_project_upgrade .cryptoairdrop-upgrade-pro-message" ).show();
			  return false;   
			}
		}
		if(parentid == 'customize-control-cryptoairdrop_testimonial_content')
		{
			var numItems = jQuery("#customize-control-cryptoairdrop_testimonial_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 1){ 
			   jQuery( "#customize-control-cryptoairdrop_testimonial_upgrade .cryptoairdrop-upgrade-pro-message" ).show();
			  return false;   
			}
		}	 */
		
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + cryptoairdrop_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
				...
				/*Set the default value in slide format*/
                field.find('.customizer-repeater-roadmap-control').val('circle-row');
				...
				/*Remove value from title field*/
                field.find('.customizer-repeater-date-control').val('');
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var contact_items = jQuery("#customize-control-cryptoairdrop_contact_content .customizer-repeater-general-control-repeater-container").length 
				if(contact_items < 3){ 
				  jQuery( "#customize-control-cryptoairdrop_contact_upgrade .cryptoairdrop-upgrade-pro-message" ).hide();
				}	
				var theme_info_items = jQuery("#customize-control-cryptoairdrop_service_content .customizer-repeater-general-control-repeater-container").length 
				if(theme_info_items < 4){ 
				  jQuery( "#customize-control-cryptoairdrop_service_upgrade .cryptoairdrop-upgrade-pro-message" ).hide();
				}/*
				var project_items = jQuery("#customize-control-cryptoairdrop_project_content .customizer-repeater-general-control-repeater-container").length 
				if(project_items < 5){ 
				  jQuery( "#customize-control-cryptoairdrop_project_upgrade .cryptoairdrop-upgrade-pro-message" ).hide(); 
				}
				var testimonial_items = jQuery("#customize-control-cryptoairdrop_testimonial_content .customizer-repeater-general-control-repeater-container").length 
				if(testimonial_items < 2){ 
				  jQuery( "#customize-control-cryptoairdrop_testimonial_upgrade .cryptoairdrop-upgrade-pro-message" ).hide();  
				} */
	...
	theme_conrols.on('change','.customizer-repeater-roadmap-control', function(){
		
		cryptoairdrop_customizer_repeater_refresh_general_control_values();
	});

	theme_conrols.on('keyup','.customizer-repeater-date-control', function(){
    ...
    theme_conrols.on('click', '.social-repeater-add-social-item', function (event) {
        ...
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + cryptoairdrop_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    theme_conrols.on('click', '.social-repeater-remove-social-item', function (event) {
        ...
        th.remove();
        cryptoairdrop_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });
...
function cryptoairdrop_escapeHtml(string) {
    'use strict';
