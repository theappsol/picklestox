(function ($) {
    'use strict';
    wp.cryptoairdrop_customizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                cryptoairdrop_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.cryptoairdrop_customizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.cryptoairdrop_customizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
                wp.cryptoairdrop_customizerRepeater.iconPickerToggle($(this));
        });
